...
namespace TiendaServicios.Api.CarritoCompra.Aplicacion
{
    public class Consulta
    {
        ...
        public class Manejador : IRequestHandler<Ejecuta, CarritoDto>
        {
            ...
            // necesito utilizar el servicio para obtener el detalle de cada libro que quiero comprar.
            private readonly ILibroService _librosServices;


            public Manejador(CarritoContexto contexto, ILibroService librosServices)
            {
                _contexto = contexto;
